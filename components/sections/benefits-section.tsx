...
const benefits = [
  ...
  { icon: Layers, key: "impact", es: "Bajo Impacto", en: "Low Footprint", desc_es: "Agentes < 40MB en RAM. Telemetría no bloqueante. Diseñado para producción.", desc_en: "Agents < 40MB RAM. Non-blocking telemetry. Production-ready." },
